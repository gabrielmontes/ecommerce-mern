...
export const newUser = (name, lastname, email, password, isAdmin) => async (dispatch, getState) => {
  try {
    ...
    dispatch(setMessage("success", 'El usuario ha sido creado con éxito.'));
  } catch (error) {
    dispatch({
...
export const register = (name, lastname, email, password) => async (dispatch) => {
  try {
    ...
    dispatch(setMessage("success", "El usuario ha sido creado, inicie sesión para continuar."));
  } catch (error) {
    dispatch({
...
export const resetPassword = (email) => async (dispatch) => {
  try {
    ...
    dispatch(setMessage("success", "Se ha enviado un correo con los pasos para reiniciar la contraseña."));
  } catch (error) {
    dispatch({
...
export const updatePassword = (id, token, password) => async (dispatch) => {
  try {
    ...
    dispatch(setMessage("success", "La contraseña ha sido actualizada con éxito."));
  } catch (error) {
    dispatch({
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    dispatch(setMessage("success", "El usuario ha sido actualizado con éxito."));
  } catch (error) {
    dispatch({
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    dispatch(setMessage("success", "El usuario ha sido eliminado con éxito."));
  } catch (error) {
    dispatch({
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    dispatch(setMessage("success", "El usuario ha sido modificado con éxito."));
  } catch (error) {
    dispatch({
